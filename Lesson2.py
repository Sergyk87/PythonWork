...
# КОРТЕЖ
# Кортеж - это неизменяемый список. Он занимает меньше места в памяти и работает быстрее, по сравнению со списками. Кортеж нужен для защиты данных от изменений.
